...
weeks = ['3 Jan 2020', '10 Jan 2020', '17 Jan 2020', '24 Jan 2020', '31 Jan 2020', 
         ...
         '20 Mar 2020', '27 Mar 2020']
all_mortality = np.array([12254, 14058, 12990, 11856, 11612, 10986, 10944, 10841, 10816, 
                          10895, 11019, 10645, 11141], 
                         dtype=np.float)
rep_deaths = np.array([2141, 2477, 2188, 1894, 1746, 1572, 1602, 1618, 1529, 1551, 1488, 1514, 1534], dtype=np.float)
...
weeks = ['3 Jan 2020 <br> (Week 1)', '10 Jan 2020', '17 Jan 2020', '24 Jan 2020', '31 Jan 2020', 
         '7 Feb 2020', '14 Feb 2020', '21 Feb 2020', '28 Feb 2020', '6 Mar 2020', '13 Mar 2020', 
         '20 Mar 2020', '27 Mar 2020 <br> (Week 13)']
all_mortality = [12254, 14058, 12990, 11856, 11612, 10986, 10944, 10841, 10816, 10895, 11019, 10645, 11141]
five_year_mort = [12175, 13822, 13216, 12760, 12206, 11925, 11627, 11548, 11183, 11498, 11205, 10573, 10130]
...
weeks = ['3 Jan 2020', '10 Jan 2020', '17 Jan 2020', '24 Jan 2020', '31 Jan 2020', 
         ...
         '13 Mar 2020', '20 Mar 2020', '27 Mar 2020']
all_mortality = np.array([12254, 14058, 12990, 11856, 11612, 10986, 10944, 10841, 10816, 10895, 11019, 10645], 
                         dtype=np.float)
deaths_under_1 = np.array([48, 50, 69, 53, 50, 31, 43, 51, 49, 56, 53, 44, 49], dtype=np.float)
deaths_1_14 = np.array([16, 26, 15, 21, 15, 16, 12, 18, 20, 20, 22, 12, 13], dtype=np.float)
deaths_15_44 = np.array([189, 275, 313, 314, 308, 271, 284, 321, 314, 313, 311, 275, 282], dtype=np.float)
...
fig.add_trace(go.Scatter(x=weeks, y=c_deaths_under_1, fill='tonexty',
                    mode= 'none', stackgroup='one', name='<1'
                        ))

fig.add_trace(go.Scatter(x= weeks, y=c_deaths_1_14, fill='tonexty',
                    mode='none', stackgroup='one', name='1-14'
                    ))

fig.add_trace(go.Scatter(x= weeks, y=c_deaths_15_44, fill='tonexty',
                    mode='none', stackgroup='one', name='15-44' 
                    ))

fig.add_trace(go.Scatter(x= weeks, y=c_deaths_45_64, fill='tonexty',
                    mode='none', stackgroup='one', name='45-64' 
                    ))

fig.add_trace(go.Scatter(x= weeks, y=c_deaths_65_74, fill='tonexty',
                    mode='none', stackgroup='one', name='65-74' 
                    ))

fig.add_trace(go.Scatter(x= weeks, y=c_deaths_75_84, fill='tonexty',
                    mode='none', stackgroup='one', name='75-84' 
                    ))

fig.add_trace(go.Scatter(x= weeks, y=c_deaths_over_85, fill='tonexty',
                    mode='none', stackgroup='one', name='85+' 
                    ))
...
c_deaths_under_1 = np.array([0,0], dtype=np.float)
c_deaths_1_14 = np.array([0,0], dtype=np.float)
c_deaths_15_44 = np.array([deaths_ht(1,eng_wales_ages_18[2]), deaths_ht(8,eng_wales_ages_18[2])], dtype=np.float)
c_deaths_45_64 = np.array([deaths_ht(6,eng_wales_ages_18[3]), deaths_ht(63,eng_wales_ages_18[3])], 
                        dtype=np.float)
c_deaths_65_74 = np.array([deaths_ht(20,eng_wales_ages_18[4]), deaths_ht(99,eng_wales_ages_18[4])], 
                        dtype=np.float)
c_deaths_75_84 = np.array([deaths_ht(31,eng_wales_ages_18[5]), deaths_ht(181,eng_wales_ages_18[5])], 
                        dtype=np.float)
c_deaths_over_85 = np.array([deaths_ht(45,eng_wales_ages_18[6]), deaths_ht(188,eng_wales_ages_18[6])], 
                          dtype=np.float)
...
fig = go.Figure(data = [
    go.Bar(name='<1', x=c_weeks, y=[0,0], text=[0,0], textposition='outside'),
    go.Bar(name='1-14', x=c_weeks, y=[0,0], text=[0,0], textposition='outside'),
